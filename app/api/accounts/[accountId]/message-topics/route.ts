...
// GET /api/accounts/[accountId]/message-topics?threadIds=id1,id2,...
...
// POST /api/accounts/[accountId]/message-topics — set (replace all), add, or remove a topic from a thread
